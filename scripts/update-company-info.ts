 ...
 * DB-driven render and the empty-DB fallback stay visually identical — and
 * crucially both point at the watermark-free `.webp` official photos (the old
 * `factory-*.png` carried an "AI generated" watermark).
 *
 * Images use the same paths generated by `scripts/convert-images.py`:
 *   /images/about/factory-assembly.webp  (replaces factory-assembly.png)
 *   /images/about/mission.svg            (vector, no watermark — kept)
 *   /images/about/vision.svg             (vector, kept)
 *   /images/about/capabilities.svg       (vector, kept)
 *
