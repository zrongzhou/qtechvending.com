...
export default function CtaSection() {
  ...
  return (
    <RevealOnScroll as="section" className="container-qtech py-20 md:py-28">
      <div className="relative min-h-[420px] overflow-hidden rounded-3xl bg-gradient-to-br from-ink-950 via-ink-900 to-ink-950 shadow-lift">
        ...
        {/* Frosted glass content panel — kept nearly transparent with NO blur so
            the colourful canvas aurora behind remains clearly visible. */}
        <div className="relative z-10 rounded-3xl bg-white/[0.02] px-8 py-12 text-center text-white sm:px-16 sm:py-16">
