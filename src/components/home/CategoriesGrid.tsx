    ...
    <section className="container-qtech bg-white py-16 lg:py-20">
      ...
      <div className="mt-10 grid snap-x gap-4 sm:grid-cols-2 lg:grid-cols-4 sm:overflow-visible sm:snap-none">
        {categories.slice(0, 8).map((cat) => {
          ...
          return (
            <Link
              ...
              className="group relative flex min-w-[260px] snap-start flex-col overflow-hidden rounded-2xl pro-card p-0 transition hover:-translate-y-1 hover:shadow-xl sm:min-w-0"
            >
              ...
              <div className="relative h-36 w-full overflow-hidden">
                ...
                <span className="absolute left-3 top-3 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-brand-500 to-brand-700 text-white shadow-md backdrop-blur">
        ...
        <Link
          ...
          className="group flex min-w-[260px] snap-start flex-col items-center justify-center overflow-hidden rounded-2xl border-2 border-dashed border-brand-300 bg-gradient-to-br from-brand-50 to-brand-100 p-0 transition hover:border-brand-500 hover:-translate-y-1 hover:shadow-lg sm:min-w-0"
        >
