...
/**
 * Flagship hero (Clean Premium): light brand-tinted backdrop, a confident value
 * proposition on the left, and the real product photo inside a soft glass card
 * on the right — no dark overlays, no heavy decoration.
 */
      ...
      <div className="container-qtech relative grid items-center gap-12 py-20 lg:grid-cols-2 lg:py-28">
        ...
        <div className="relative">
          <div className="glass-card relative overflow-hidden p-3">
            ...
            {/* Static credibility badge */}
            <div className="absolute -left-4 -top-4 hidden items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-2.5 shadow-lift sm:inline-flex">
              <IconTile
                icon={Star}
                className="h-4 w-4"
